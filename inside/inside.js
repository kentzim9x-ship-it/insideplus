...
const originalProducts = [
    {
        ...
        colors: [
            {
                name: "Đen", hex: "#000000", images: ["https://images.unsplash.com/photo-1588850561407-ed78c282e89b?auto=format&fit=crop&q=80&w=1200", "https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&q=80&w=1200"],
                sizes: [
            ...
            {
                name: "Xám SA045", hex: "#6b7280", images: ["https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&q=80&w=1200"],
                sizes: [
                    { name: "S", outOfStock: true },
                    { name: "M", outOfStock: true },
                    { name: "L", outOfStock: true }
    ...
    },
    {
        ...
        colors: [
            {
                name: "Trắng", hex: "#ffffff", images: ["https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&q=80&w=1200", "https://images.unsplash.com/photo-1588850561407-ed78c282e89b?auto=format&fit=crop&q=80&w=1200"],
                sizes: [
            ...
            {
                name: "Đen", hex: "#000000", images: ["https://images.unsplash.com/photo-1588850561407-ed78c282e89b?auto=format&fit=crop&q=80&w=1200"],
                sizes: [
                    { name: "M", outOfStock: false },
                    { name: "L", outOfStock: false },
                    { name: "XL", outOfStock: true }
    ...
    },
    {
        ...
        colors: [
            {
                name: "Be", hex: "#e3c4a8", images: ["https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&q=80&w=1200"],
                sizes: [
                    { name: "S", outOfStock: true },
                    { name: "M", outOfStock: true },
                    { name: "L", outOfStock: true },
            ...
            {
                name: "Trắng", hex: "#ffffff", images: ["https://images.unsplash.com/photo-1588850561407-ed78c282e89b?auto=format&fit=crop&q=80&w=1200"],
                sizes: [
                    { name: "S", outOfStock: true },
                    { name: "M", outOfStock: true },
                    { name: "L", outOfStock: true },
    ...
    },
    {
        ...
        colors: [
            {
                name: "Đen", hex: "#000000", images: ["https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&q=80&w=1200"],
                sizes: [
                    { name: "M", outOfStock: false },
                    { name: "L", outOfStock: false }
                ]
    ...
    },
    {
        ...
        colors: [
            {
                name: "Be", hex: "#e3c4a8", images: ["https://images.unsplash.com/photo-1588850561407-ed78c282e89b?auto=format&fit=crop&q=80&w=1200"],
                sizes: [
                    { name: "M", outOfStock: false },
                    { name: "L", outOfStock: false }
                ]
...
function selectVisualFilter(styleVal) {
    ...
    if (titleHeading) {
        if (styleVal === 'ALL') {
            ...
            titleHeading.innerText = 'Quần Lót ' + styleVal;
        }
    }
...
function openProductDrawer(id) {
    ...
    setTimeout(function () {
        ...
        // Đảm bảo cuộn lên đầu ngay cả sau khi hiệu ứng slide-in hoàn tất
        if (drawerPanel) {
            drawerPanel.scrollTop = 0;
...
function closeProductDrawer() {
    ...
    setTimeout(function () { 
        ...
        // Đặt lại vị trí cuộn về 0 khi ẩn drawer hoàn toàn
        const drawerPanel = document.getElementById('product-drawer-panel');
