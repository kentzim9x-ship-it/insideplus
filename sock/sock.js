const visualFilterCategories = [
    {
        ...
        title: "Tất cả",
        styleValue: "ALL",
        image: "https://images.unsplash.com/photo-1586350977771-b3b0abd50c82?auto=format&fit=crop&q=80&w=600"
    },
    {
        id: "CO_NGAN",
        title: "Tất Cổ Ngắn",
...
const originalProducts = [
    {
        ...
        colors: [
            {
                name: "Trắng", hex: "#ffffff", images: ["https://images.unsplash.com/photo-1586350977771-b3b0abd50c82?auto=format&fit=crop&q=80&w=1200", "https://images.unsplash.com/photo-1582588678413-dbf45f4823e9?auto=format&fit=crop&q=80&w=1200"],
                sizes: [
                    { name: "Freesize", outOfStock: false }
                ]
            },
            {
                name: "Đen", hex: "#000000", images: ["https://images.unsplash.com/photo-1582588678413-dbf45f4823e9?auto=format&fit=crop&q=80&w=1200"],
                sizes: [
                    { name: "Freesize", outOfStock: true }
                ]
            }
        ]
    },
    {
        ...
        colors: [
            ...
            {
                name: "Trắng", hex: "#ffffff", images: ["https://images.unsplash.com/photo-1586350977771-b3b0abd50c82?auto=format&fit=crop&q=80&w=1200"],
                sizes: [
                    { name: "Freesize", outOfStock: true }
                ]
            }
...
function selectVisualFilter(styleVal) {
    ...
    if (titleHeading) {
        if (styleVal === 'ALL') {
            ...
            titleHeading.innerText = catObj ? catObj.title : ('Tất Vớ ' + styleVal);
        }
    }
